 ...
 *
 * This code has been highly modified to implement the login mechanism of Bitshares.
 * Contributor(s):
 * Brian Bowles
 * ***** END LICENSE BLOCK ***** */
...
//		'integrate_profile_areas' => 'bitshares_profile_areas', not used anymore
	...
	db_add_col('members','btsname','varchar',255);
    db_add_col('members','btsid','varchar',255);
	
	
function pre_installCheck(){

    if (version_compare(PHP_VERSION, '5.2.0', '<'))
		fatal_error('<strong>PHP 5 or geater is required to install Bitshares Login.  Please advise your host that PHP4 is no longer maintained and ask that they upgrade you to PHP5.</strong><br />');
}
