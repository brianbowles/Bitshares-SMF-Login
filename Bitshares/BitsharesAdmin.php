...
function bitsharesa(){
	...
	$subActions = array(
	   'bitshares' => 'bitshares_admin',
	   'bitshares_logs' => 'bitshares_logs',
	);
...
function bitshares_logs(){
    global $sourcedir, $smcFunc, $scripturl, $txt, $context;
	    ...
	    $list_options = array(
		    'id' => 'bts_list',
		    'title' => $txt['bts_app_logs'] ,
		    'items_per_page' => 30,
		    'base_href' => $scripturl . '?action=admin;area=bitshares;sa=bitshares_logs',
		...
		'no_items_label' => $txt['bts_app_logsnon'],
		'columns' => array(
			'id_member' => array(
				'header' => array(
					'value' => $txt['bts_app_logs1'],
				),
				'data' => array(
			...
			'btsname' => array(
				...
				'sort' =>  array(
					'default' => 'btsname',
					'reverse' => 'btsname DESC',
				),
			),
			'btsid' => array(
				'header' => array(
					'value' => $txt['bts_app_logs3'],
				),
				'data' => array(
					'function' => create_function('$row', '
						return $row[\'btsid\'];'),
		...
		'form' => array(
			'href' => $scripturl.'?action=admin;area=bitshares;sa=bitshares_logs',
			'include_sort' => true,
			'include_start' => true,
			'hidden_fields' => array(
