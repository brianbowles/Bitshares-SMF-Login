...
You will need to install the Bitshares command line client.

Edit the .Bitshares/config.json file and find this portion
...
Go into bitsharesClientApi.php and edit the following .  TODO - where does this end up on install?
