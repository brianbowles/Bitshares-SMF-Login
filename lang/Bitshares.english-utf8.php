...
/* We will remove gp* after changing things TODO */

$helptxt['bts_app_client_id'] = 'In this section you MUST enter the Client ID from your BitShares application. If you have not yet created your application please do so now. For more information, please read <a href="http://www.sa-smf.com/community/index.php?action=kb;area=article;cont=42" target="_blank">-->here<--</a>';
$helptxt['bts_app_client_secret'] = 'In this section you MUST enter the Client secret from your BitShares application. If you have not yet created your application please do so now. For more information, please read <a href="http://www.sa-smf.com/community/index.php?action=kb;area=article;cont=42" target="_blank">-->here<--</a>';
$helptxt['bts_app_detait_gid'] = ' You may specify what membergroup new members that register with BitShares will belong to Use 0 to disable';
$helptxt['bts_app_custon_logurl'] = 'You may specify what what URL users will be redirected to when logging in with BitShares you may leave empty to disable and use the default board url';
...
$helptxt['bts_app_board_showplus1'] = 'This will show BitShares button on selected boards just enter the board ID\'s separated with a , leave blank to disable';
...
$txt['bts_app_board_showplus1'] = 'boards to show bitShares1 button on';
...
$txt['bts_app_client_secret'] = 'Client secret';
$txt['bts_app_client_id'] = 'Client id';
$txt['bts_app_oauth'] = 'Oauth consumer key';
$txt['bts_app_oauth_secret'] = 'Oauth consumer secret';
$txt['bts_app_custon_logurl'] = 'Custom login url';
$txt['bts_app_custon_logimg'] = 'Custom login Image';
$txt['bts_app_detait_gid'] = 'Default membergroup ID';
